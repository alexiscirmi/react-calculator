...
function ButtonContainer() {
  ...
  return (
    <Container className='buttonContainer'>
      <Row>
        <Col><ButtonCustom variant={'success'} value={'AC'} onClick={() => clearClick()} /></Col>
        <Col><ButtonCustom variant={'success'} value={'('} onClick={() => buttonClick('(')} /></Col>
        <Col><ButtonCustom variant={'success'} value={')'} onClick={() => buttonClick(')')} /></Col>
        <Col><ButtonCustom variant={'success'} value={'÷'} onClick={() => buttonClick('/')} /></Col>
      </Row>
      ...
      <Row>
        ...
        <Col><ButtonCustom variant={'success'} value={'X'} onClick={() => buttonClick('*')} /></Col>
      </Row>
      ...
      <Row>
        ...
        <Col><ButtonCustom variant={'success'} value={','} onClick={() => buttonClick('.')} /></Col>
        <Col><ButtonCustom variant={'success'} value={'%'} onClick={() => buttonClick('%')} /></Col>
        <Col><ButtonCustom variant={'success'} value={'='} onClick={() => equalClick()} /></Col>
      </Row>
